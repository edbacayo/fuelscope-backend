    ...
    try {
        ...
        if (fuelData.length === 0 && serviceData.length === 0) {
            return res
                ...
                .json({
                    message:
                        "No fuel or service data found for the selected vehicle.",
                });
        }
        ...
        const kilometersTraveled =
            fuelStats.maxOdometer - fuelStats.minOdometer;
        const totalCost =
            fuelStats.totalFuelCost + serviceStats.totalServiceCost;
        const averageCostPerKm =
            kilometersTraveled > 0 ? totalCost / kilometersTraveled : 0;
